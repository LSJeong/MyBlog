						...
						<tr>
							...
							<td style="text-align: center;">
								<c:if test="${not empty id }">
									<button class="button small" onclick="boardDelete(${board.no}, '${board.id }' , this);">Delete</button>
								</c:if>
								<c:if test="${empty id }">
									<button disabled="disabled" class="button small" onclick="boardDelete(${board.no}, ${board.id }, this);">Delete</button>
								</c:if>
							</td>
						</tr>
